    ...
    public string GetBindingText(Binding binding)
    {
        switch(binding)
        {
            ...
            case Binding.Move_Up:
                return playerInputAction.Player.Move.bindings[1].ToString();

            case Binding.Move_Down:

                return playerInputAction.Player.Move.bindings[2].ToString();

            case Binding.Move_Left:

                return playerInputAction.Player.Move.bindings[3].ToString();

            case Binding.Move_Right:

                return playerInputAction.Player.Move.bindings[4].ToString();
